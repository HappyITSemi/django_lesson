    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('me', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sns_me',
                                         to=settings.AUTH_USER_MODEL, verbose_name='自分・ユーザー')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('me', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='friend_me',
                                         to=settings.AUTH_USER_MODEL, verbose_name='自分・ユーザー')),
                ('my_friend',
